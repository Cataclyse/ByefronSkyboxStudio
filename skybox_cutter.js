...
const WORKER_URL=WORKER_OVERRIDE||"https://skybox.cataclyse.xyz/robloxassets";
...
async function uploadAll(){
  ...
  for(let i=0;i<FACE_ORDER.length;i++){
    ...
    try{
      ...
      const jsonPart=JSON.stringify({assetType:"Image",displayName:`${preset}_${FACE_SHORT[face]}`.slice(0,50),description:"Skybox face",creationContext:{creator:{userId}},openUse:true});
